...
![Linux 背景知识](/images/binder/Linux 背景知识.png)
...
![用户空间与内核空间内存](/images/binder/用户空间与内核空间内存.png)
...
![传统IPC通信原理](/images/binder/传统IPC通信原理.png)
...
![Binder通信原理](/images/binder/Binder通信原理.png)
...
![Binder通信原理-1](/images/binder/Binder通信原理-1.png)
...
![互联网通信模型](/images/binder/互联网通信模型.png)
...
![Binder通信模型](/images/binder/Binder通信模型.png)
...
![Binder代理与本地模型](/images/binder/Binder代理与本地模型.png)
...
![Binder例子截图](/images/binder/Binder例子截图.png)
